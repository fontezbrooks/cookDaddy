...
const styles = StyleSheet.create({
  ...
  heading: { textAlign: 'center', color: DesignTokens.color.accent },
  recipeTitle: { textAlign: 'center', color: DesignTokens.color.ink.light },
  ...
  ctaSecondary: { backgroundColor: DesignTokens.color.surfaceAlt.light },
  ctaPrimaryText: { color: DesignTokens.color.onAccent, fontWeight: '700' },
  ctaSecondaryText: { color: DesignTokens.color.brand.light, fontWeight: '600' },
});
